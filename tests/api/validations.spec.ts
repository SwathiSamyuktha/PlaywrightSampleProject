...
test.describe('API validations — status and headers', () => {
  test('GET returns 200 and HTML content-type', async ({ request, logger }) => {
  ...
  test('GET /login returns 200 and body contains Login', async ({ request }) => {
  ...
  test('status_codes 404 returns 404', async ({ request }) => {
    const res = await request.get('/status_codes/404');
    expect(res.status()).toBe(404);
  });

  test('status_codes 500 returns 500', async ({ request }) => {
    const res = await request.get('/status_codes/500');
    expect(res.status()).toBe(500);
  });

  test('response has reasonable timing', async ({ request }) => {
...
test.describe('API validations — redirects', () => {
  test('redirect returns 302 and Location header', async ({ request }) => {
...
test.describe('API validations — JSON (JSONPlaceholder)', () => {
  test('GET posts returns 200 and JSON array', async ({ request, logger }) => {
  ...
  test('GET single post returns 200 and expected shape', async ({ request }) => {
  ...
  test('POST create returns 201 and body has id', async ({ request }) => {
  ...
  test('PUT update returns 200 and returns updated data', async ({ request }) => {
  ...
  test('PATCH partial update returns 200', async ({ request }) => {
...
test.describe('API validations — headers and body size', () => {
  test('response has content-length or transfer-encoding', async ({ request }) => {
  ...
  test('GET returns non-empty body', async ({ request }) => {
    const res = await request.get('/');
    const body = await res.text();
